...
public class InetAddressesAssert
        extends AbstractInetAddressesAssert<InetAddressesAssert, InetAddresses> {

    /**
     * Creates a new <code>{@link InetAddressesAssert}</code> to make assertions on actual
     * InetAddresses.
     *
    ...
    /**
     * An entry point for InetAddressesAssert to follow AssertJ standard <code>assertThat()</code>
     * statements.<br>
     * With a static import, one can write directly: <code>assertThat(myInetAddresses)</code> and
