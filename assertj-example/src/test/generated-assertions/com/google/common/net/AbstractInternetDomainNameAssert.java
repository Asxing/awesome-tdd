...
/**
 * Abstract base class for {@link InternetDomainName} specific assertions - Generated by
 * CustomAssertionGenerator.
 */
@javax.annotation.Generated(value = "assertj-assertions-generator")
public abstract class AbstractInternetDomainNameAssert<
                S extends AbstractInternetDomainNameAssert<S, A>, A extends InternetDomainName>
        extends AbstractObjectAssert<S, A> {

    /**
     * Creates a new <code>{@link AbstractInternetDomainNameAssert}</code> to make assertions on
     * actual InternetDomainName.
     *
     ...
     * @return this assertion object.
     * @throws AssertionError - if the actual InternetDomainName's name is not equal to the given
     *     one.
     */
     ...
     *
     * @param parts the given elements that should be contained in actual InternetDomainName's
     *     parts.
     * @return this assertion object.
     * @throws AssertionError if the actual InternetDomainName's parts does not contain all given
     *     String elements.
     */
    public S hasParts(String... parts) {
        ...
        Iterables.instance()
                .assertContains(
                        info,
                        org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue(
                                "parts", com.google.common.collect.ImmutableList.class, actual),
                        parts);
    ...
    /**
     * Verifies that the actual InternetDomainName's parts contains the given String elements in
     * Collection.
     *
     * @param parts the given elements that should be contained in actual InternetDomainName's
     *     parts.
    ...
    /**
     * Verifies that the actual InternetDomainName's parts contains <b>only</b> the given String
    ...
    /**
     * Verifies that the actual InternetDomainName's parts does not contain the given String
     * elements.
     *
     * @param parts the given elements that should not be in actual InternetDomainName's parts.
     * @return this assertion object.
     * @throws AssertionError if the actual InternetDomainName's parts contains any given String
     *     elements.
     */
    ...
    public S hasNoParts() {
        ...
        if (org.assertj.core.util.introspection.FieldSupport.EXTRACTION
                .fieldValue("parts", com.google.common.collect.ImmutableList.class, actual)
                .iterator()
                .hasNext()) {
            failWithMessage(
                    assertjErrorMessage,
     ...
     *
     * @param publicSuffixIndex the given publicSuffixIndex to compare the actual
     *     InternetDomainName's publicSuffixIndex to.
     * @return this assertion object.
     * @throws AssertionError - if the actual InternetDomainName's publicSuffixIndex is not equal to
     *     the given one.
     */
    public S hasPublicSuffixIndex(int publicSuffixIndex) {
        ...
        // check
        int actualPublicSuffixIndex =
                org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue(
                        "publicSuffixIndex", int.class, actual);
        if (actualPublicSuffixIndex != publicSuffixIndex) {
            failWithMessage(
                    assertjErrorMessage, actual, publicSuffixIndex, actualPublicSuffixIndex);
        }
