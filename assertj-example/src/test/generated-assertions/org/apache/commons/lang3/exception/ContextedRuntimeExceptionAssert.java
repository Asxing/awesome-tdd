...
public class ContextedRuntimeExceptionAssert
        extends AbstractContextedRuntimeExceptionAssert<
                ContextedRuntimeExceptionAssert, ContextedRuntimeException> {

    /**
     * Creates a new <code>{@link ContextedRuntimeExceptionAssert}</code> to make assertions on
     * actual ContextedRuntimeException.
     *
    ...
    /**
     * An entry point for ContextedRuntimeExceptionAssert to follow AssertJ standard <code>
     * assertThat()</code> statements.<br>
     * With a static import, one can write directly: <code>assertThat(myContextedRuntimeException)
