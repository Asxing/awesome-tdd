...
/**
 * Abstract base class for {@link TolkienCharacter} specific assertions - Generated by
 * CustomAssertionGenerator.
 */
@javax.annotation.Generated(value = "assertj-assertions-generator")
public abstract class AbstractTolkienCharacterAssert<
                S extends AbstractTolkienCharacterAssert<S, A>, A extends TolkienCharacter>
        extends AbstractObjectAssert<S, A> {

    /**
     * Creates a new <code>{@link AbstractTolkienCharacterAssert}</code> to make assertions on
     * actual TolkienCharacter.
     *
     ...
     * @return this assertion object.
     * @throws AssertionError - if the actual TolkienCharacter's surname is not equal to the given
     *     one.
     */
     ...
     *
     * @param notAccessibleField the given notAccessibleField to compare the actual
     *     TolkienCharacter's notAccessibleField to.
     * @return this assertion object.
     * @throws AssertionError - if the actual TolkienCharacter's notAccessibleField is not equal to
     *     the given one.
     */
    public S hasNotAccessibleField(long notAccessibleField) {
        ...
        // check
        long actualNotAccessibleField =
                org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue(
                        "notAccessibleField", long.class, actual);
        if (actualNotAccessibleField != notAccessibleField) {
            failWithMessage(
                    assertjErrorMessage, actual, notAccessibleField, actualNotAccessibleField);
        }
