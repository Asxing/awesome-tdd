...
/**
 * Abstract base class for {@link WithGenericListType} specific assertions - Generated by
 * CustomAssertionGenerator.
 */
@javax.annotation.Generated(value = "assertj-assertions-generator")
public abstract class AbstractWithGenericListTypeAssert<
                S extends AbstractWithGenericListTypeAssert<S, A>, A extends WithGenericListType>
        extends AbstractObjectAssert<S, A> {

    /**
     * Creates a new <code>{@link AbstractWithGenericListTypeAssert}</code> to make assertions on
     * actual WithGenericListType.
     *
    ...
    /**
     * Verifies that the actual WithGenericListType's movies contains the given
     * org.assertj.examples.data.movie.Movie elements.
     *
     * @param movies the given elements that should be contained in actual WithGenericListType's
     *     movies.
     * @return this assertion object.
     * @throws AssertionError if the actual WithGenericListType's movies does not contain all given
     *     org.assertj.examples.data.movie.Movie elements.
     */
    ...
    /**
     * Verifies that the actual WithGenericListType's movies contains the given
     * org.assertj.examples.data.movie.Movie elements in Collection.
     *
     * @param movies the given elements that should be contained in actual WithGenericListType's
     *     movies.
     * @return this assertion object.
     ...
     */
    public S hasMovies(
            java.util.Collection<? extends org.assertj.examples.data.movie.Movie> movies) {
        // check that actual WithGenericListType we want to make assertions on is not null.
        isNotNull();
    ...
    /**
     * Verifies that the actual WithGenericListType's movies contains <b>only</b> the given
     * org.assertj.examples.data.movie.Movie elements and nothing else in whatever order.
     *
     * @param movies the given elements that should be contained in actual WithGenericListType's
     *     movies.
     * @return this assertion object.
    ...
    /**
     * Verifies that the actual WithGenericListType's movies contains <b>only</b> the given
     * org.assertj.examples.data.movie.Movie elements in Collection and nothing else in whatever
     * order.
     *
     * @param movies the given elements that should be contained in actual WithGenericListType's
     *     movies.
    ...
    /**
     * Verifies that the actual WithGenericListType's movies does not contain the given
     * org.assertj.examples.data.movie.Movie elements.
     *
     * @param movies the given elements that should not be in actual WithGenericListType's movies.
     * @return this assertion object.
     * @throws AssertionError if the actual WithGenericListType's movies contains any given
     *     org.assertj.examples.data.movie.Movie elements.
     */
