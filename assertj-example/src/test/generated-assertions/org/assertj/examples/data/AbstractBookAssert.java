...
public abstract class AbstractBookAssert<S extends AbstractBookAssert<S, A>, A extends Book>
    ...
    /**
     * Verifies that the actual Book's pryce is close to the given value by less than the given
     * offset.
     *
    ...
    public S hasPryceCloseTo(double pryce, double assertjOffset) {
        ...
        // check
        Assertions.assertThat(actualPryce)
                .overridingErrorMessage(assertjErrorMessage)
                .isCloseTo(pryce, Assertions.within(assertjOffset));
