...
public class EmployeeTitleAssert
        extends AbstractEmployeeTitleAssert<EmployeeTitleAssert, Employee.Title> {

    /**
     * Creates a new <code>{@link EmployeeTitleAssert}</code> to make assertions on actual
     * Employee.Title.
     *
    ...
    /**
     * An entry point for EmployeeTitleAssert to follow AssertJ standard <code>assertThat()</code>
     * statements.<br>
     * With a static import, one can write directly: <code>assertThat(myEmployee.Title)</code> and
