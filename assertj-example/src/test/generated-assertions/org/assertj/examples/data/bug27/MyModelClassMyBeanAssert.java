...
public class MyModelClassMyBeanAssert
        extends AbstractMyModelClassMyBeanAssert<MyModelClassMyBeanAssert, MyModelClass.MyBean> {

    /**
     * Creates a new <code>{@link MyModelClassMyBeanAssert}</code> to make assertions on actual
     * MyModelClass.MyBean.
     *
    ...
    /**
     * An entry point for MyModelClassMyBeanAssert to follow AssertJ standard <code>assertThat()
     * </code> statements.<br>
     * With a static import, one can write directly: <code>assertThat(myMyModelClass.MyBean)</code>
