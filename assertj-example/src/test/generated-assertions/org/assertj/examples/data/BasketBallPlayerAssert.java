...
public class BasketBallPlayerAssert
        extends AbstractBasketBallPlayerAssert<BasketBallPlayerAssert, BasketBallPlayer> {

    /**
     * Creates a new <code>{@link BasketBallPlayerAssert}</code> to make assertions on actual
     * BasketBallPlayer.
     *
    ...
    /**
     * An entry point for BasketBallPlayerAssert to follow AssertJ standard <code>assertThat()
     * </code> statements.<br>
     * With a static import, one can write directly: <code>assertThat(myBasketBallPlayer)</code> and
