...
/**
 * Abstract base class for {@link TeamManager} specific assertions - Generated by
 * CustomAssertionGenerator.
 */
@javax.annotation.Generated(value = "assertj-assertions-generator")
public abstract class AbstractTeamManagerAssert<
                S extends AbstractTeamManagerAssert<S, A>, A extends TeamManager>
        extends AbstractObjectAssert<S, A> {

    /**
     * Creates a new <code>{@link AbstractTeamManagerAssert}</code> to make assertions on actual
     * TeamManager.
     *
    ...
    /**
     * Verifies that the actual TeamManager's players contains the given
     * org.assertj.examples.data.BasketBallPlayer elements.
     *
     * @param players the given elements that should be contained in actual TeamManager's players.
     * @return this assertion object.
     * @throws AssertionError if the actual TeamManager's players does not contain all given
     *     org.assertj.examples.data.BasketBallPlayer elements.
     */
    ...
    /**
     * Verifies that the actual TeamManager's players contains the given
     * org.assertj.examples.data.BasketBallPlayer elements in Collection.
     *
     * @param players the given elements that should be contained in actual TeamManager's players.
     * @return this assertion object.
     * @throws AssertionError if the actual TeamManager's players does not contain all given
     ...
     */
    public S hasPlayers(
            java.util.Collection<? extends org.assertj.examples.data.BasketBallPlayer> players) {
        // check that actual TeamManager we want to make assertions on is not null.
        isNotNull();
    ...
    /**
     * Verifies that the actual TeamManager's players contains <b>only</b> the given
     * org.assertj.examples.data.BasketBallPlayer elements and nothing else in whatever order.
     *
     * @param players the given elements that should be contained in actual TeamManager's players.
     * @return this assertion object.
     * @throws AssertionError if the actual TeamManager's players does not contain all given
    ...
    /**
     * Verifies that the actual TeamManager's players contains <b>only</b> the given
     * org.assertj.examples.data.BasketBallPlayer elements in Collection and nothing else in
     * whatever order.
     *
     * @param players the given elements that should be contained in actual TeamManager's players.
     * @return this assertion object.
    ...
    /**
     * Verifies that the actual TeamManager's players does not contain the given
     * org.assertj.examples.data.BasketBallPlayer elements.
     *
     * @param players the given elements that should not be in actual TeamManager's players.
     * @return this assertion object.
     * @throws AssertionError if the actual TeamManager's players contains any given
     *     org.assertj.examples.data.BasketBallPlayer elements.
     */
