...
/**
 * Abstract base class for {@link GameService} specific assertions - Generated by
 * CustomAssertionGenerator.
 */
@javax.annotation.Generated(value = "assertj-assertions-generator")
public abstract class AbstractGameServiceAssert<
                S extends AbstractGameServiceAssert<S, A>, A extends GameService>
        extends AbstractObjectAssert<S, A> {

    /**
     * Creates a new <code>{@link AbstractGameServiceAssert}</code> to make assertions on actual
     * GameService.
     *
     ...
     * @throws AssertionError - if the actual GameService's teamManager is not equal to the given
     *     one.
     */
