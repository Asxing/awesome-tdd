...
public class MyIteratorWrapperAssert
        extends AbstractMyIteratorWrapperAssert<MyIteratorWrapperAssert, MyIteratorWrapper> {

    /**
     * Creates a new <code>{@link MyIteratorWrapperAssert}</code> to make assertions on actual
     * MyIteratorWrapper.
     *
    ...
    /**
     * An entry point for MyIteratorWrapperAssert to follow AssertJ standard <code>assertThat()
     * </code> statements.<br>
     * With a static import, one can write directly: <code>assertThat(myMyIteratorWrapper)</code>
