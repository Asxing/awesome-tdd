...
public abstract class AbstractTeamAssert<S extends AbstractTeamAssert<S, A>, A extends Team>
     ...
     * @throws AssertionError if the actual Team's players does not contain all given
    ...
    /**
     * Verifies that the actual Team's players contains the given BasketBallPlayer elements in
     * Collection.
     *
     * @param players the given elements that should be contained in actual Team's players.
     * @return this assertion object.
    ...
    /**
     * Verifies that the actual Team's players contains <b>only</b> the given BasketBallPlayer
     ...
     * @return this assertion object.
     * @throws AssertionError if the actual Team's players contains any given BasketBallPlayer
     *     elements.
     */
