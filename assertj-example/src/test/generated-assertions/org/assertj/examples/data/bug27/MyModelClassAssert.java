...
public class MyModelClassAssert
        extends AbstractMyModelClassAssert<MyModelClassAssert, MyModelClass> {

    /**
     * Creates a new <code>{@link MyModelClassAssert}</code> to make assertions on actual
     * MyModelClass.
     *
    ...
    /**
     * An entry point for MyModelClassAssert to follow AssertJ standard <code>assertThat()</code>
     * statements.<br>
     * With a static import, one can write directly: <code>assertThat(myMyModelClass)</code> and get
