...
/**
 * Abstract base class for {@link Employee.Title} specific assertions - Generated by
 * CustomAssertionGenerator.
 */
@javax.annotation.Generated(value = "assertj-assertions-generator")
public abstract class AbstractEmployeeTitleAssert<
                S extends AbstractEmployeeTitleAssert<S, A>, A extends Employee.Title>
        extends AbstractObjectAssert<S, A> {

    /**
     * Creates a new <code>{@link AbstractEmployeeTitleAssert}</code> to make assertions on actual
     * Employee.Title.
     *
     ...
     * @throws AssertionError - if the actual Employee.Title's position is not equal to the given
     *     one.
     */
