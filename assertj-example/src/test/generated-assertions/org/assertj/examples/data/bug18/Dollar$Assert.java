...
public class Dollar$Assert extends AbstractDollar$Assert<Dollar$Assert, Dollar$> {
    ...
    /**
     * An entry point for Dollar$Assert to follow AssertJ standard <code>assertThat()</code>
     * statements.<br>
     * With a static import, one can write directly: <code>assertThat(myDollar$)</code> and get
