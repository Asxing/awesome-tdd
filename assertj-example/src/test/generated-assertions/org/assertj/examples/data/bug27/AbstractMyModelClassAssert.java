...
/**
 * Abstract base class for {@link MyModelClass} specific assertions - Generated by
 * CustomAssertionGenerator.
 */
@javax.annotation.Generated(value = "assertj-assertions-generator")
public abstract class AbstractMyModelClassAssert<
                S extends AbstractMyModelClassAssert<S, A>, A extends MyModelClass>
        extends AbstractObjectAssert<S, A> {

    /**
     * Creates a new <code>{@link AbstractMyModelClassAssert}</code> to make assertions on actual
     * MyModelClass.
     *
    ...
    public S hasIterator(MyIteratorWrapper iterator) {
        ...
        // null safe check
        MyIteratorWrapper actualIterator =
                org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue(
                        "iterator", MyIteratorWrapper.class, actual);
