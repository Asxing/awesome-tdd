...
public class OptionalAssertionsExamples extends AbstractAssertionsExamples {
    ...
    public void optional_assertions_examples() {
        ...
        assertThat(optional).isPresent().containsInstanceOf(String.class).contains("Test");
        ...
        Condition<TolkienCharacter> isAnElf =
                new Condition<>(character -> character.getRace() == Race.ELF, "an elf");
    ...
    public void primitives_optional_assertions_examples() {
        ...
        assertThat(optional).isPresent().hasValue(12);
    ...
    public void map_optional_assertion_example() {
        Optional<String> optional = Optional.of("YODA");
        assertThat(optional).map(String::length).hasValue(4);
    }
    ...
    public void hasValueSatisfying_with_condition_assertion_example() {
        ...
        Condition<TolkienCharacter> isAnElf =
                new Condition<>(character -> character.getRace() == ELF, "an elf");
    ...
    public void flatMap_optional_assertion_example() {
        ...
        assertThat(Optional.<String>ofNullable(null)).flatMap(UPPER_CASE_OPTIONAL_STRING).isEmpty();
    }
