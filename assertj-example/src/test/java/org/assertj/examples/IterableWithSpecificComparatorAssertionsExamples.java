...
public class IterableWithSpecificComparatorAssertionsExamples extends AbstractAssertionsExamples {
    ...
    public void iterable_assertions_with_specific_comparator_by_element_field_or_type_examples() {
        ...
        assertThat(hobbits)
                .usingComparatorForElementFieldsWithNames(closeEnough, "height")
        ...
        assertThat(hobbits)
                .usingComparatorForElementFieldsWithType(closeEnough, Double.class)
                .usingFieldByFieldElementComparator()
                .contains(tallerDude);
        ...
        try {
            ...
            logAssertionErrorMessage(
                    "contains for Iterable usingComparatorForElementFieldsWithNames", e);
        }
    }
