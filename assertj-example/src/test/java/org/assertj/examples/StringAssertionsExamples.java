...
public class StringAssertionsExamples extends AbstractAssertionsExamples {
    ...
    public void string_assertions_with_custom_comparison_examples() {
        ...
        // standard assertion are based on equals() method, but what if you want to ignore String
        // case ?
        ...
        // if you want consistent ignoring case comparison, you must use a case iNsenSiTIve
        // comparison strategy :
        ...
        // All assertions made after usingComparator(caseInsensitiveStringComparator) are based on
        ...
        try {
            // failed assertion with specific comparator mention the comparison strategy to help
    ...
    public void charSequence_subclasses_assertions_examples() {
        ...
        Comparator<CharSequence> caseInsensitiveComparator =
    ...
    public void xml_assertions_examples() {
        ...
        // XML String don't need to be formatted, AssertJ will format both actual and expected
        // string before comparison.
        // Whatever how formatted your xml string is, isXmlEqualTo assertion is able to compare it
        // with another xml String.
        String oneLineXml =
                "<rings><bearer><name>Frodo</name><ring><name>one ring</name><createdBy>Sauron</createdBy></ring></bearer></rings>";
        ...
        // Since both actual and expected xml string are formatted as XML document, it is easy to
        // see what were the
        // differences.
    ...
    public void pattern_assertion_example() {
        assertThat("Frodo").containsPattern("Fr.d").containsPattern(Pattern.compile("Fr.d"));
    ...
    public void should_support_comparable_assertions() {
        ...
        assertThat("xyz").isGreaterThan("abc").isGreaterThan("xy").isGreaterThan("ABC");
        assertThat("XYZ").usingComparator(caseInsensitiveStringComparator).isGreaterThan("abc");
        ...
        assertThat("abc")
                .usingComparator(
                        caseInsensitiveStringComparator, "String case insensitive comparator")
                .isEqualTo("Abc")
                .isEqualTo("ABC");
    }
}
