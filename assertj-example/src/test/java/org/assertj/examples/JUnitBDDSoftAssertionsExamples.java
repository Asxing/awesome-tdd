...
public class JUnitBDDSoftAssertionsExamples extends AbstractAssertionsExamples {
    ...
    @Rule public final JUnitBDDSoftAssertions softly = new JUnitBDDSoftAssertions();
    ...
    public void failing_junit_soft_assertions_example() {
        ...
        // no need to call softly.assertAll(); (as with SoftAssertions) error gathering is handled
        // by the JUnit rule
    }
