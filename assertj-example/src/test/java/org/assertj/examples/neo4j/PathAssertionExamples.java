...
public class PathAssertionExamples extends Neo4jAssertionExamples {
    ...
    public void path_assertion_examples() {
        try (Transaction ignored = graphDatabase().beginTx()) {
            ...
            Path bulmaToMasterRoshiPath =
                    dragonBallGraphRepository.findShortestPathBetween("Bulma", "Master Roshi");
            ...
            final Node masterRoshiNode =
                    dragonBallGraphRepository.findUniqueCharacter("Master Roshi");
            final Relationship sonGokuTraining =
                    dragonBallGraphRepository.findUniqueTraining("Son Goku");
    ...
    public void path_assertion_examples_introduced_in_2_0_0_and_2_0_1() throws Exception {
        try (Transaction ignored = graphDatabase().beginTx()) {
            ...
            DragonBallGraphRepository dragonBallGraphRepository = dragonBallGraphRepository();
            Path sonGokuToDoctorFlappe =
                    dragonBallGraphRepository.findShortestPathBetween("Son Goku", "Dr. Flappe");
            ...
            final Relationship masterShenTraining =
                    dragonBallGraphRepository.findUniqueTraining("Master Shen");
