...
public class UsingConditionExamples extends AbstractAssertionsExamples {
    ...
    public void is_condition_example() {
        ...
        Condition<? super List<? extends BasketBallPlayer>> listCond =
                new Condition<>(list -> true, "test");
    ...
    public void satisfies_condition_example() {
        // Given
        Condition<String> fairyTale =
                new Condition<>(s -> s.startsWith("Once upon a time"), "fairy tale start");
        // When
            ...
            assertThat("Gandalf")
                    .has(
                            anyOf(
                                    ...
                                    allOf(
                                            contains("o"),
                                            anyOf(contains("a"), contains("b"), contains("c")))));
        } catch (AssertionError e) {
    ...
    public void condition_built_with_predicate_example() {
        Condition<String> fairyTale =
                new Condition<>(s -> s.startsWith("Once upon a time"), "a %s tale", "fairy");
        String littleRedCap = "Once upon a time there was a dear little girl ...";
    ...
    private final Condition<String> sith =
            new Condition<String>("sith") {
    ...
    private final Condition<String> sithPower =
            new Condition<String>("sith power") {
                private final Set<String> siths = newLinkedHashSet("Sidious", "Vader", "Plagueis");
