...
public class ChangesAssertionExamples extends AbstractAssertionsExamples {
    ...
    public void basic_row_assertion_examples() throws SQLException, ParseException {
        ...
        assertThat(changes)
                ...
                .hasNumberOfColumns(6)
                .hasValues(
                        1, "Hewson", "Paul David", "Bono Vox", DateValue.parse("1960-05-10"), 1.75)
                .change()
                .rowAtStartPoint()
                .exists()
                .hasNumberOfColumns(6)
    ...
    public void changetype_assertion_examples() throws SQLException {
        ...
        assertThat(changes)
                .change()
                .isOfType(ChangeType.CREATION)
                .isCreation()
                .change()
                .isOfType(ChangeType.MODIFICATION)
                .isModification()
                .change()
                .isOfType(ChangeType.DELETION)
                .isDeletion();
    }
    ...
    public void column_equality_assertion_examples() throws SQLException {
        ...
        assertThat(changes)
                ...
                .hasValues(15, null)
                .column()
                .hasValues(DateValue.of(2014, 9, 9), null)
                .column()
                .hasValues("Songs of Innocence", null)
                .column()
                .hasValues(11, null)
                .column()
                .hasValues(TimeValue.of(0, 48, 11), null);
    }
    ...
    public void column_type_assertion_examples() throws SQLException {
        ...
        assertThat(changes)
                ...
                .column()
                .isNumber(true)
                .isOfType(ValueType.NUMBER, true)
                .isOfAnyTypeIn(ValueType.NUMBER, ValueType.NOT_IDENTIFIED)
                .column()
                .isText(true)
                .isOfType(ValueType.TEXT, true)
                .isOfAnyTypeIn(ValueType.TEXT, ValueType.NOT_IDENTIFIED)
                .column()
                .isText(true)
                .isOfType(ValueType.TEXT, true)
                .isOfAnyTypeIn(ValueType.TEXT, ValueType.NOT_IDENTIFIED)
                ...
                .isOfAnyTypeIn(ValueType.NUMBER)
                .column()
                .isText(false)
                .isOfType(ValueType.TEXT, false)
                .isOfAnyTypeIn(ValueType.TEXT)
                .column()
                .isText(false)
                .isOfType(ValueType.TEXT, false)
                .isOfAnyTypeIn(ValueType.TEXT)
                ...
                .column()
                .isDate(false)
                .isOfType(ValueType.DATE, false)
                .isOfAnyTypeIn(ValueType.DATE)
                .column()
                .isNumber(false)
                .isOfType(ValueType.NUMBER, false)
                .isOfAnyTypeIn(ValueType.NUMBER)
                ...
                .column()
                .isDate(true)
                .isOfType(ValueType.DATE, true)
                .isOfAnyTypeIn(ValueType.DATE, ValueType.NOT_IDENTIFIED)
                .column()
                .isText(true)
                .isOfType(ValueType.TEXT, true)
                .isOfAnyTypeIn(ValueType.TEXT, ValueType.NOT_IDENTIFIED)
                ...
                .column()
                .isTime(true)
                .isOfType(ValueType.TIME, true)
                .isOfAnyTypeIn(ValueType.TIME, ValueType.NOT_IDENTIFIED);
    }
    ...
    public void row_equality_assertion_examples() throws SQLException {
        ...
        assertThat(changes)
                .change()
                .rowAtEndPoint()
                .hasValues(5, "McGuiness", "Paul", null, DateValue.of(1951, 6, 17), null)
                .change()
                .rowAtStartPoint()
                .hasValues(1, "Hewson", "Paul David", "Bono", DateValue.of(1960, 5, 10), 1.75)
                .rowAtEndPoint()
                .hasValues(1, "Hewson", "Paul David", "Bono Vox", DateValue.of(1960, 5, 10), 1.75)
                .change()
                .rowAtStartPoint()
                .hasValues(
                        15,
    ...
    public void value_equality_assertion_examples() throws SQLException {
        ...
        assertThat(changes)
                ...
                .isEqualTo(15)
                .value()
                .isEqualTo(DateValue.of(2014, 9, 9))
                .value()
                .isEqualTo("Songs of Innocence")
                .value()
                .isEqualTo(11)
                .value()
                .isEqualTo(TimeValue.of(0, 48, 11))
                .column()
                .valueAtStartPoint()
                .isEqualTo(15)
                .column()
    ...
    public void value_non_equality_assertion_examples() throws SQLException {
        ...
        assertThat(changes)
                ...
                .isNotZero()
                .value()
                .isNotEqualTo("-McGuiness")
                .value()
                .isNotEqualTo("-Paul")
                .value()
                .value()
                .isNotEqualTo(DateValue.of(1951, 6, 18))
                .column()
                .valueAtEndPoint()
                .isNotEqualTo(6)
                .isNotZero()
                ...
                .column()
                .valueAtEndPoint()
                .isNotEqualTo(DateValue.of(1951, 7, 17))
                .change()
                .rowAtStartPoint()
                .value()
                .isNotEqualTo(2)
                .isNotZero()
                .value()
                .isNotEqualTo("H-ewson")
                .value()
                .isNotEqualTo("Pa-ul David")
                .value()
                .isNotEqualTo("Bon-o")
                .value()
                .isNotEqualTo(DateValue.of(1860, 5, 10))
                .value()
                .isNotEqualTo(1.756)
                .isNotZero()
                .rowAtEndPoint()
                ...
                .isNotEqualTo("-Hewson")
                .value()
                .isNotEqualTo("P-aul David")
                .value()
                .isNotEqualTo("Bo-no Vox")
                .value()
                .isNotEqualTo(DateValue.of(1760, 5, 10))
                .value()
                .isNotEqualTo(1.759)
                .isNotZero()
                .column()
                ...
                .isNotEqualTo("-Hewson")
                .valueAtEndPoint()
                .isNotEqualTo("Hew-son")
                .column()
                .valueAtStartPoint()
                .isNotEqualTo("Pa-ul David")
                .valueAtEndPoint()
                .isNotEqualTo("Paul -David")
                .column()
                .valueAtStartPoint()
                .isNotEqualTo("Bono-")
                .valueAtEndPoint()
                .isNotEqualTo("Bono Vo-x")
                .column()
                .valueAtStartPoint()
                .isNotEqualTo(DateValue.of(960, 5, 10))
                .valueAtEndPoint()
                .isNotEqualTo(DateValue.of(190, 5, 10))
                .column()
                .valueAtStartPoint()
                .isNotEqualTo(1.5)
                .isNotZero()
                ...
                .isNotZero()
                .value()
                .isNotEqualTo(DateValue.of(2114, 9, 9))
                .value()
                .isNotEqualTo("Songs of Innoc-ence")
                .value()
                .isNotEqualTo(15)
                .isNotZero()
                .value()
                .isNotEqualTo(TimeValue.of(0, 58, 11))
                .column()
                .valueAtStartPoint()
                .isNotEqualTo(1)
                .isNotZero()
                .column()
                .valueAtStartPoint()
                .isNotEqualTo(DateValue.of(2014, 9, 8))
                .column()
                .valueAtStartPoint()
                .isNotEqualTo("Songs of Innocnce")
                .column()
                .valueAtStartPoint()
                .isNotEqualTo(16)
                .isNotZero()
                .column()
                .valueAtStartPoint()
                .isNotEqualTo(TimeValue.of(1, 48, 11));
    }
    ...
    public void value_type_assertion_examples() throws SQLException {
        ...
        assertThat(changes)
                ...
                .value()
                .isNumber()
                .isOfType(ValueType.NUMBER)
                .isOfAnyTypeIn(ValueType.NUMBER, ValueType.BOOLEAN)
                .value()
                .isText()
                .isOfType(ValueType.TEXT)
                .isOfAnyTypeIn(ValueType.TEXT, ValueType.BOOLEAN)
                .value()
                .isText()
                .isOfType(ValueType.TEXT)
                .isOfAnyTypeIn(ValueType.TEXT, ValueType.BOOLEAN)
                ...
                .value()
                .isDate()
                .isOfType(ValueType.DATE)
                .isOfAnyTypeIn(ValueType.DATE, ValueType.BOOLEAN)
                .column()
                .valueAtEndPoint()
                .isNumber()
                .isOfType(ValueType.NUMBER)
                ...
                .value()
                .isTime()
                .isOfType(ValueType.TIME)
                .isOfAnyTypeIn(ValueType.TIME, ValueType.BOOLEAN)
                .column()
                .valueAtStartPoint()
                .isNumber()
                .isOfType(ValueType.NUMBER)
