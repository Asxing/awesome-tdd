...
public class TableAssertionExamples extends AbstractAssertionsExamples {
    ...
    public void basic_column_table_assertion_examples() {
        ...
        assertThat(table).column("name").hasValues("Hewson", "Evans", "Clayton", "Mullen");
    }
    ...
    public void table_inclusion_examples() {
        Table table =
                new Table(dataSource, "members", new String[] {"id", "name", "firstname"}, null);

        assertThat(table).hasNumberOfColumns(3);
        assertThat(table).row().hasNumberOfColumns(3).hasValues(1, "Hewson", "Paul David");
    }
    ...
    public void table_exclusion_examples() {
        Table table =
                new Table(dataSource, "members", null, new String[] {"id", "name", "firstname"});
    ...
    public void text_for_numeric_table_assertion_examples() {
        ...
        assertThat(table).row(1).value("size").isEqualTo("1.77").isNotEqualTo("1.78");

        Table table1 = new Table(dataSource, "albums");

        assertThat(table1).row(14).value("numberofsongs").isEqualTo("11").isNotEqualTo("12");
    }
    ...
    public void type_table_assertion_examples() {
        ...
        assertThat(table)
                ...
                .value()
                .isDate()
                .isOfAnyTypeIn(ValueType.DATE, ValueType.NUMBER)
                .value()
                .isText()
                .value()
                .isNumber()
    ...
    /**
     * This example shows possible assertions on the date. In this example, we can see that the
     * assertions are
     */
    @Test
    public void date_table_assertion_examples() {
        ...
        assertThat(table)
                ...
                .isBeforeOrEqualTo(
                        DateTimeValue.of(DateValue.of(1961, 8, 9), TimeValue.of(0, 0, 1, 3)));
    }
    ...
    public void columns_number_assertion_examples() {
        ...
        assertThat(table).hasNumberOfColumns(6).row().hasNumberOfColumns(6);
    }
    ...
    public void rows_number_assertion_examples() {
        ...
        assertThat(table).hasNumberOfRows(4).column().hasNumberOfRows(4);
    }
    ...
    public void column_equality_assertion_examples() {
        ...
        assertThat(table)
                ...
                .column()
                .hasValues("Paul David", "David Howell", "Adam", "Larry")
                .column()
                .hasValues("Bono", "The Edge", null, null)
                .column()
                .hasValues(
    ...
    public void row_equality_assertion_examples() {
        ...
        assertThat(table)
                ...
                .hasValues(2, "Evans", "David Howell", "The Edge", DateValue.of(1961, 8, 8), 1.77)
                .row()
                .hasValues(3, "Clayton", "Adam", null, DateValue.of(1960, 3, 13), 1.78)
                .row()
                .hasValues(4, "Mullen", "Larry", null, DateValue.of(1961, 10, 31), 1.7);
    }
    ...
    public void value_equality_assertion_examples() {
        ...
        assertThat(table)
                ...
                .isEqualTo(DateValue.of(1961, 8, 8))
                .value()
                .isEqualTo(DateValue.of(1960, 3, 13))
                .value()
                .isEqualTo(DateValue.of(1961, 10, 31))
                .column()
                .value()
                .isEqualTo(1.75)
                .value()
    ...
    public void value_type_assertion_examples() {
        ...
        assertThat(table)
                ...
                .isOfAnyTypeIn(ValueType.TEXT)
                .value()
                .isOfType(ValueType.NOT_IDENTIFIED)
                .isOfAnyTypeIn(ValueType.NOT_IDENTIFIED)
                .value()
                .isOfType(ValueType.NOT_IDENTIFIED)
                .isOfAnyTypeIn(ValueType.NOT_IDENTIFIED)
                .column()
    ...
    public void value_non_equality_assertion_examples() {
        ...
        assertThat(table)
                ...
                .column()
                .value()
                .isNotEqualTo("H0ewson")
                .value()
                .isNotEqualTo("Ev0ans")
                .value()
                .isNotEqualTo("Cla0yton")
                .value()
                .isNotEqualTo("Mull0en")
                .column()
                .value()
                .isNotEqualTo("Paul 0David")
                .value()
                .isNotEqualTo("David 0Howell")
                .value()
                .isNotEqualTo("0Adam")
                .value()
                .isNotEqualTo("L0arry")
                ...
                .isNotEqualTo("Bo0no")
                .value()
                .isNotEqualTo("The0 Edge")
                .value()
                .value()
                .column()
                .value()
                .isNotEqualTo(DateValue.of(160, 5, 10))
                .value()
                .isNotEqualTo(DateValue.of(161, 8, 8))
                .value()
                .isNotEqualTo(DateValue.of(160, 3, 13))
                .value()
                .isNotEqualTo(DateValue.of(161, 10, 31))
                .column()
                .value()
                .isNotEqualTo(175)
                .value()
                ...
                .isNotEqualTo("H0ewson")
                .value()
                .isNotEqualTo("Pa0ul David")
                .value()
                .isNotEqualTo("Bon0o")
                .value()
                .isNotEqualTo(DateValue.of(196, 5, 10))
                .value()
                .isNotEqualTo(1.7)
                .row()
                .value()
                ...
                .isNotEqualTo("vans")
                .value()
                .isNotEqualTo("avid Howell")
                .value()
                .isNotEqualTo("he Edge")
                .value()
                .isNotEqualTo(DateValue.of(1961, 9, 8))
                .value()
                .isNotEqualTo(1.7)
                .row()
                .value()
                ...
                .value()
                .value()
                .isNotEqualTo(DateValue.of(1960, 2, 13))
                .value()
                .isNotEqualTo(1.8)
                .row()
                .value()
                ...
                .value()
                .value()
                .isNotEqualTo(DateValue.of(1961, 10, 1))
                .value()
                .isNotEqualTo(1.07);
    }
