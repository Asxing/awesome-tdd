...
public class AbstractAssertionsExamples {
    ...
    private static final String MEMBERS_CREATE_REQUEST =
            "create table members(id number primary key, name varchar not null, firstname varchar not null, surname varchar, birthdate date, size decimal);";
    ...
    private static final String ALBUMS_CREATE_REQUEST =
            "create table albums(id number primary key, release date not null, title varchar not null, numberofsongs int, duration time, live boolean);";
    ...
    protected void makeChangesInTheData() throws SQLException {
        ...
        conn.createStatement()
                .executeUpdate(
                        "insert into members values (5, 'McGuiness', 'Paul', null, PARSEDATETIME('17/06/1951', 'dd/MM/yyyy'), null);");
        conn.createStatement()
                .executeUpdate("update members set surname = 'Bono Vox' where id = 1;");
