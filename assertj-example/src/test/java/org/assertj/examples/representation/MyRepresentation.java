 ...
 *
 * <p>To register a {@link Representation}, you need to add the file
 *
 * <pre>org.assertj.core.presentation.Representation</pre>
 *
 * in META-INF/services, it must contain the fully qualified class name of the {@link
 * Representation} to use, in our case: {@code
 * org.assertj.examples.representation.CustomRepresentation}
 */
