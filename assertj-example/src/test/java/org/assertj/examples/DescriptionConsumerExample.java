...
public class DescriptionConsumerExample extends AbstractAssertionsExamples {
    ...
    public void isEqualTo_isNotEqualTo_assertions_examples() {
        // GIVEN
        final StringBuilder descriptionReportBuilder =
                new StringBuilder(String.format("Assertions:%n"));
        Consumer<Description> descriptionConsumer =
                desc -> descriptionReportBuilder.append(String.format("-- %s%n", desc));
        ...
        assertThat(frodo.getRace()).as("check race").isEqualTo(HOBBIT);

        // THEN
        Assertions.setDescriptionConsumer(null);
        String descriptionReport = descriptionReportBuilder.toString();
        assertThat(descriptionReport)
                .isEqualTo(format("Assertions:%n" + "-- check name%n" + "-- check race%n"));
        // unset the consumer
        Assertions.setDescriptionConsumer(null);
    }
}
