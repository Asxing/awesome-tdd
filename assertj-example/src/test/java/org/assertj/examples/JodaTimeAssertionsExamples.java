...
public class JodaTimeAssertionsExamples extends AbstractAssertionsExamples {
    ...
    public void localDateTime_assertions_examples() {
        ...
        assertThat(new LocalDateTime("2000-01-01"))
                .isIn(new LocalDateTime("1999-12-31"), new LocalDateTime("2000-01-01"));
        assertThat(new LocalDateTime("2000-01-01"))
                .isNotIn(new LocalDateTime("1999-12-31"), new LocalDateTime("2000-01-02"));
        // same assertions but parameters is String based representation of LocalDateTime
        assertThat(new LocalDateTime("2000-01-01"))
                .isIn("1999-12-31", "2000-01-01")
                .isNotIn("1999-12-31", "2000-01-02");
    ...
    public void localDate_assertions_examples() {
        ...
        assertThat(new LocalDate("2000-01-01"))
                .isEqualTo(new LocalDate("2000-01-01"))
                .isNotEqualTo(new LocalDate("2000-01-15"));
        // same assertions but parameters is String based representation of LocalDate
        assertThat(new LocalDate("2000-01-01")).isEqualTo("2000-01-01").isNotEqualTo("2000-01-15");

        assertThat(new LocalDate("2000-01-01"))
                .isBefore(new LocalDate("2000-01-02"))
                .isAfter(new LocalDate("1999-12-31"));
        // same assertions but parameters is String based representation of LocalDate
        assertThat(new LocalDate("2000-01-01")).isBefore("2000-01-02").isAfter("1999-12-31");

        assertThat(new LocalDate("2000-01-01"))
                .isIn(new LocalDate("1999-12-31"), new LocalDate("2000-01-01"));
        assertThat(new LocalDate("2000-01-01"))
                .isNotIn(new LocalDate("1999-12-31"), new LocalDate("2000-01-02"));
        // same assertions but parameters is String based representation of LocalDate
        assertThat(new LocalDate("2000-01-01"))
                .isIn("1999-12-31", "2000-01-01")
                .isNotIn("1999-12-31", "2000-01-02");
