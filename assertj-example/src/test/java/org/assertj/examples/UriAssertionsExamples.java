...
public class UriAssertionsExamples extends AbstractAssertionsExamples {
    ...
    public void uri_assertions_examples() throws URISyntaxException {
        ...
        assertThat(new URI("http://test:pass@www.helloworld.org/index.html"))
                .hasUserInfo("test:pass");
    ...
    public void url_assertions_examples() throws MalformedURLException {
        ...
        assertThat(new URL("http://www.helloworld.org/index.html?happy=very"))
                .hasParameter("happy");
        assertThat(new URL("http://www.helloworld.org/index.html?happy"))
                .hasParameter("happy", null);
        assertThat(new URL("http://www.helloworld.org/index.html?happy=very"))
                .hasParameter("happy", "very");
