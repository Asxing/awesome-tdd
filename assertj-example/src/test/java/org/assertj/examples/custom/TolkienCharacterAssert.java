...
/**
 * A simple class to illustrate how to extend AssertJ assertions with custom ones to make assertions
 * speicific to {@link TolkienCharacter}.
 *
...
public class TolkienCharacterAssert
    ...
    // 2 - Write a constructor to build your assertion class from the object you want make
    // assertions on.
    /**
    ...
    // the other option here is to gather all your specific assertions entry point to a class
    // inehriting from Assertions
     ...
     * </code> statements.<br>
     * With a static import, one's can write directly : <code>assertThat(frodo).hasName("Frodo");
     * </code>
     *
     * @param actual the TolkienCharacter we want to make assertions on.
    ...
    public TolkienCharacterAssert hasName(String name) {
        ...
        if (!actual.getName().equals(name)) {
            failWithMessage(
                    "Expected character's name to be <%s> but was <%s>", name, actual.getName());
        }
