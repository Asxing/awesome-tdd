...
public class JUnit4_SoftAssertionsWithCustomAssertExamples extends AbstractAssertionsExamples {

    @Rule public final MyProjectJUnitSoftAssertions softly = new MyProjectJUnitSoftAssertions();
    ...
    // comment the @Ignore to see the test failing with all the assertion error and not only the
    // first one.
    @Test
    @Ignore
