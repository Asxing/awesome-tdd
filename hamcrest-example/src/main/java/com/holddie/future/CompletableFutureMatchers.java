...
/**
 * Matchers for {@link CompletionStage} instances.
 *
...
public final class CompletableFutureMatchers {
    ...
    /**
     * Creates a {@link Matcher} that matches when the {@link CompletionStage} completes with a
     * value.
     *
    ...
    /**
     * Creates a {@link Matcher} that matches when the {@link CompletionStage} completes with a
     * value that matches the given Matcher.
     *
     * <p><strong>If the {@link CompletionStage} has not yet completed, this matcher waits for it to
     * finish.</strong>
     */
