    ...
    public static void describeNestedMismatches(
        ...
        for (String key : allKeys) {
            if (mismatchedKeys.containsKey(key)) {
                // If this is not the first key and the previous key was not a mismatch then add
                // ellipsis
                ...
                describeMismatchForKey(
                        key, mismatchDescription, describeKey, mismatchedKeys.get(key));
