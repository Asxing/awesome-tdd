...
import static com.holddie.future.TestUtils.waitUntilInterrupted;
...
public class ExceptionallyCompletedCompletionStageTest {

  private static final Matcher<CompletionStage<?>> SUT =
      stageCompletedWithExceptionThat(isA(RuntimeException.class));
  ...
  public void testDescriptionFormatting() throws Exception {
    ...
    assertThat(
        ...
        is("a stage that completed with an exception "
