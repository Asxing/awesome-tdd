...
public class SuccessfullyCompletedBlockingFutureTest {
  ...
  private static final Matcher<Future<? extends Integer>> SUT = FutureMatchers
      .futureWillCompleteWithValueThat(is(1));
  ...
  public void testMismatchFormatting() throws Exception {
    ...
    assertThat(description.toString(),
                      is("a future that completed with a value that was <2>"));
  }
