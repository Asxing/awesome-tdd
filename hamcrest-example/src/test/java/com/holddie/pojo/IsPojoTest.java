...
import static com.holddie.pojo.IsPojo.pojo;
...
public class IsPojoTest {
    ...
    public void testThrowsException() throws Exception {
        final IsPojo<SomeClass> sut =
                pojo(SomeClass.class).where("throwsException", is(anything()));
    ...
    public void testWrongType() throws Exception {
        ...
        assertThat(
                description.toString(),
                is("not an instance of com.spotify.hamcrest.pojo.SomeClass"));
    }
    ...
    public void testTypeSafeMatch() throws Exception {
        final IsPojo<SomeClass> sut =
                pojo(SomeClass.class)
                        ...
                        .where(
                                SomeClass::baz,
                                is(pojo(SomeClass.class).where(SomeClass::foo, is(42))));
    ...
    public void testTypeSafeMismatch() throws Exception {
        final IsPojo<SomeClass> sut =
                pojo(SomeClass.class)
                        ...
                        .where(
                                SomeClass::baz,
                                is(pojo(SomeClass.class).where(SomeClass::foo, is(43))));
        ...
        expectedException.expect(
                both(isA(IllegalArgumentException.class))
                        .and(
                                hasProperty(
                                        "message",
                                        startsWith("Multiple entries with same key: "))));
                ...
                both(isA(IllegalArgumentException.class))
                        .and(
                                hasProperty(
                                        "message",
                                        is(
                                                "The supplied lambda is not a direct method reference"))));
